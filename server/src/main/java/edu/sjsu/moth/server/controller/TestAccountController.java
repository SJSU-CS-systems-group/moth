...
public class TestAccountController {
    ...
    static private final String ADD_FORM =
            "</table><input type=\"submit\" value=\"Delete\"><br></form>" + "<form " + "action=/accounts/adding" +
                    "><label for=\"id\">Id:</label><br><input type=\"text\" " + "name=\"id\"><br><br>" + "<label " +
                    "for=\"id\">Username:</label><br><input type=\"text\" name=\"username\"><br><br>" + "<label " +
                    "for=\"acct\">Account:</label><br><input type=\"text\" name=\"acct\"><br><br>" + "<label " + "for" +
                    "=\"url\">Url:</label><br><input type=\"text\" name=\"url\"><br><br>" +
    ...
    static private final String ACCOUNT_ROW =
            "<tr><td><input type=\"checkbox\" name=\"del\" " + "value=\"%s\"/></td" + "><td>%s</td><td>%s</td><td>%s" + "</td><td>%s" + "</td></tr>";
    @Autowired
    ...
    public Mono<ResponseEntity<String>> getAccounts() {
        return accountRepository.findAll()
                .collect(StringBuilder::new,
                         (sb, a) -> sb.append(ACCOUNT_ROW.formatted(a.acct, a.id, a.acct, a.username, a.url)))
