...
@JsonPropertyOrder({ "id", "phrase", "context", "whole_word", "expires_at", "irreversible" })
public class Filter {
    ...
    public Filter(String id, String phrase, List<String> context, Boolean wholeWord, String expiresAt,
    ...
    public boolean equals(Object other) {
        ...
        return (((((((this.wholeWord == rhs.wholeWord) ||
                ((this.wholeWord != null) && this.wholeWord.equals(rhs.wholeWord))) &&
                ((this.phrase == rhs.phrase) || ((this.phrase != null) && this.phrase.equals(rhs.phrase)))) &&
                ((this.context == rhs.context) || ((this.context != null) && this.context.equals(rhs.context)))) &&
                ((this.irreversible == rhs.irreversible) ||
                        ((this.irreversible != null) && this.irreversible.equals(rhs.irreversible)))) &&
                ((this.id == rhs.id) || ((this.id != null) && this.id.equals(rhs.id)))) &&
                ((this.expiresAt == rhs.expiresAt) ||
                        ((this.expiresAt != null) && this.expiresAt.equals(rhs.expiresAt))));
    }
