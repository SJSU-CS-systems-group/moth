...
public class Report {
    ...
    public Report(String id, Boolean actionTaken, Object actionTakenAt, String category, String comment, Boolean forwarded, String createdAt, List<String> statusIds, Object ruleIds, CredentialAccount targetAccount) {
        super();
        this.id = id;
