...
// CHANGES MADE:
//   * change type from TargetAccount (deleted) to CredentialAccount
...
@JsonPropertyOrder({ "id", "action_taken", "action_taken_at", "category", "comment", "forwarded", "created_at",
        "status_ids", "rule_ids", "target_account" })
public class Report {
    @JsonProperty("id")
    public String id;
    ...
    public CredentialAccount targetAccount;
    ...
    public Report(String id, Boolean actionTaken, Object actionTakenAt, String category, String comment,
                  Boolean forwarded, String createdAt, List<String> statusIds, Object ruleIds,
                  CredentialAccount targetAccount) {
        super();
        this.id = id;
