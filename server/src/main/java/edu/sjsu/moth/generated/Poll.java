...
public class Poll {
    ...
    public Poll(String id, String expiresAt, Boolean expired, Boolean multiple, Integer votesCount, Integer votersCount, Boolean voted, List<Integer> ownVotes, List<Option> options, List<CustomEmoji> emojis) {
        super();
        this.id = id;
    ...
    public boolean equals(Object other) {
        ...
        Poll rhs = ((Poll) other);
        return (((((((((((this.emojis == rhs.emojis)||((this.emojis!= null)&&this.emojis.equals(rhs.emojis)))&&((this.expired == rhs.expired)||((this.expired!= null)&&this.expired.equals(rhs.expired))))&&((this.votesCount == rhs.votesCount)||((this.votesCount!= null)&&this.votesCount.equals(rhs.votesCount))))&&((this.votersCount == rhs.votersCount)||((this.votersCount!= null)&&this.votersCount.equals(rhs.votersCount))))&&((this.multiple == rhs.multiple)||((this.multiple!= null)&&this.multiple.equals(rhs.multiple))))&&((this.options == rhs.options)||((this.options!= null)&&this.options.equals(rhs.options))))&&((this.voted == rhs.voted)||((this.voted!= null)&&this.voted.equals(rhs.voted))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.expiresAt == rhs.expiresAt)||((this.expiresAt!= null)&&this.expiresAt.equals(rhs.expiresAt))))&&((this.ownVotes == rhs.ownVotes)||((this.ownVotes!= null)&&this.ownVotes.equals(rhs.ownVotes))));
    }
