...
// CHANGES MADE:
//   renamed from Account to NotificationAccount
...
public class NotificationAccount {
    ...
    public NotificationAccount(String id, String username, String acct) {
        super();
        this.id = id;
    ...
    public String toString() {
        ...
        sb.append(
                NotificationAccount.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NotificationAccount) == false) {
            return false;
        }
        NotificationAccount rhs = ((NotificationAccount) other);
