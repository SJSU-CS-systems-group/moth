...
@JsonPropertyOrder({ "id", "following", "showing_reblogs", "notifying", "followed_by", "blocking", "blocked_by",
        "muting", "muting_notifications", "requested", "requested_by", "domain_blocking", "endorsed", "note" })
public class Relationship {
    ...
    public Relationship(String id, Boolean following, Boolean showingReblogs, Boolean notifying, Boolean followedBy,
                        Boolean blocking, Boolean blockedBy, Boolean muting, Boolean mutingNotifications,
                        Boolean requested, Boolean requestedBy, Boolean domainBlocking, Boolean endorsed, String note) {
        super();
        this.id = id;
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((this.note == rhs.note) || ((this.note != null) && this.note.equals(rhs.note))) &&
                ((this.notifying == rhs.notifying) ||
                        ((this.notifying != null) && this.notifying.equals(rhs.notifying)))) &&
                ((this.blockedBy == rhs.blockedBy) ||
                        ((this.blockedBy != null) && this.blockedBy.equals(rhs.blockedBy)))) &&
                ((this.mutingNotifications == rhs.mutingNotifications) || ((this.mutingNotifications != null) &&
                        this.mutingNotifications.equals(rhs.mutingNotifications)))) &&
                ((this.endorsed == rhs.endorsed) || ((this.endorsed != null) && this.endorsed.equals(rhs.endorsed)))) &&
                ((this.muting == rhs.muting) || ((this.muting != null) && this.muting.equals(rhs.muting)))) &&
                ((this.requestedBy == rhs.requestedBy) ||
                        ((this.requestedBy != null) && this.requestedBy.equals(rhs.requestedBy)))) &&
                ((this.followedBy == rhs.followedBy) ||
                        ((this.followedBy != null) && this.followedBy.equals(rhs.followedBy)))) &&
                ((this.requested == rhs.requested) ||
                        ((this.requested != null) && this.requested.equals(rhs.requested)))) &&
                ((this.blocking == rhs.blocking) || ((this.blocking != null) && this.blocking.equals(rhs.blocking)))) &&
                ((this.following == rhs.following) ||
                        ((this.following != null) && this.following.equals(rhs.following)))) &&
                ((this.id == rhs.id) || ((this.id != null) && this.id.equals(rhs.id)))) &&
                ((this.showingReblogs == rhs.showingReblogs) ||
                        ((this.showingReblogs != null) && this.showingReblogs.equals(rhs.showingReblogs)))) &&
                ((this.domainBlocking == rhs.domainBlocking) ||
                        ((this.domainBlocking != null) && this.domainBlocking.equals(rhs.domainBlocking))));
    }
